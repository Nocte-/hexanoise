...
static const std::unordered_map<std::string, funcdef> functions{
    ...
    {"rotate3", {node::rotate3, xyz, {xyz,
                {"axis_x", var}, {"axis_y", var}, {"axis_z", var},
                {"angle", var}}}},
    ...
    {"fractal3",
     {node::fractal3,
      ...
      {xyz,
       ...
       {"lacunarity", var, 2.0},
       {"persistence", var, 0.5}}}},
    {"xplane", {node::xplane, xyz, {xy, {"x", var, 0.0}}}},
    {"yplane", {node::yplane, xyz, {xy, {"y", var, 0.0}}}},
